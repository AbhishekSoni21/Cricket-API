    ...
    return (
      <div className="header-container">
        <div className="header-container-wrapper">
          <div className="header-logo">{"Cric API"}</div>
        ...
        <div className="dashboard-container">
          <div className={this.state.selectedDashboardCss}>
            {this.generateBody()}
          </div>
          {this.state.currentNav ? (
            ...
            <div className="welcome">
              <h2 className="header-app">The Ultimate Cricket</h2>
              <p className="app-message">
                Explore the world of Cricket with live cricket score, player
                statistics, fantasy scorecard and many more...
              </p>
            </div>
          )}
        </div>
