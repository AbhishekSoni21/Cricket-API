    ...
    return (
      <div className="card-container" key={index}>
        <div className="label-container">
          ...
          <div className="label-value">{match["unique_id"]}</div>
        </div>
        <div className="label-container">
        ...
        <div className="label-container">
          ...
          <div className="label-value">{match.date.split("T")[0]}</div>
        </div>
        <div className="label-container">
          <div className="label">{"Type"}</div>
          <div className="label-value">{match["type"]}</div>
        </div>
        <div className="label-container">
          <div className="label">{"Match Started"}</div>
          <div className="label-value">
            {JSON.stringify(match["matchStarted"])}
          </div>
        </div>
        <div className="label-container">
          <div className="label">{"Squad"}</div>
          <div className="label-value">
            {JSON.stringify(match["squad"])}
          </div>{" "}
        </div>
      </div>
    );
